...
**概念モデルとの対応**（作品・楽譜の4階層やイベントとの関係）は、別紙 [`../テーブル設計/LRMoo対応付け.md`](../テーブル設計/LRMoo対応付け.md) および [`../テーブル設計/LRMoo概念図.md`](../テーブル設計/LRMoo概念図.md) を参照してください。本可視化は **テーブル定義ドキュメントに記載された外部キー** をグラフ化したものです。
